...
class carOwner(models.Model):
    owner_name = models.CharField('Full name', max_length = 100, null=True, help_text = "Please enter your full name")
    owner_email = models.CharField('Email', max_length = 100, null=True, help_text = ' Please enter your email')
    car = models.ForeignKey(Car, on_delete = models.RESTRICT, null = True)
    image = models.ImageField('Car Picture', upload_to='images/', null = True)
